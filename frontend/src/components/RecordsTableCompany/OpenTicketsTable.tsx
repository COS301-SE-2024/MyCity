...
const records: RecordType[] = [
  ...
  { id: 'SA0301', faultType: 'Road Damage', status: 'Fix in progress', createdBy: 'Kyle Marshall', address: '312 Rupert Street BAAAAAAAAAAAA', urgency: 'medium' , municipality: 'City of Cape Town' },
