...
const IncidentTable = () => {
  ...
  return (
    <div className="text-white p-4">
      <div className="grid grid-cols-5 gap-4 items-center mb-2 px-2 py-1 rounded-lg text-black font-bold">
      ...
      {incidents.map((incident, index) => (
        <div
          key={index}
          className="grid grid-cols-5 gap-4 items-center mb-2 px-2 py-1 rounded-lg bg-white text-black border-b border-gray-200"
        >
