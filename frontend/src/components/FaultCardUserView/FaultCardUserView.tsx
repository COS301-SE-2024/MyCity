    ...
    <div className="block sm:hidden h-full overflow-auto flex justify-center items-center">
      <div className="flex flex-col w-full gap-2 text-black relative h-full overflow-y-auto justify-center">
        ...
        <div className="text-center">
          ...
          <div className="text-gray-400 text-sm sm:text-md truncate">{ticketNumber}</div>
        </div>

        {/* Status */}
        <div className={`${color} bg-opacity-75 text-black font-bold text-center rounded-lg px-2 py-1 w-full`}>
          {text}
        </div>
