...
export default function NavbarTwo() {
  ...
  return (
    <nav className="fixed top-0 w-full bg-white p-4 flex items-center justify-between shadow-md">
      <Link href="/">
      ...
      <div className="flex-initial text-[0.95rem] flex me-5 space-x-5 items-center">
        ...
        <Link href="/" className={isActive("/") ? "text-blue-500 font-semibold" : "text-black hover:text-gray-600"}>
          <div className={cn(isActive("/") ? "font-bold" : "", "flex flex-col gap-1 items-center")}>
            <Building2 size={25} />
            <span >Welcome</span>
          </div>
        </Link>
