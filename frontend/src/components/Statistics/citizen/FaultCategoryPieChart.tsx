...
export default function FaultCategoryBarChart({ data }: FaultCategoryBarChartProps) {
    ...
    datasets: [
      {
        ...
        backgroundColor: [
          'rgba(173, 216, 230, 0.6)', 'rgba(255, 218, 185, 0.6)', 'rgba(144, 238, 144, 0.6)',  'rgba(255, 99, 132, 0.6)', 'rgba(128, 0, 128, 0.6)', 
          'rgba(255, 182, 193, 0.6)','rgba(255, 255, 102, 0.6)', 'rgba(221, 160, 221, 0.6)'
        ],
      },
    ],
  };
  ...
  return (
    <div className="bg-white rounded-lg p-4 shadow-lg h-[40vh]">
      <h3 className="text-black text-2xl mb-4">Fault Reports by Category</h3>
      <div className="h-[70%]">
