...
const CommentComponent = ({ seen }: any) => {
  ...
  return (
    <div className="flex items-center bg-white bg-opacity-70 text-black text-center justify-between p-4 mb-2 mx-4 rounded-lg">
      ...
      <div className="flex-1">
        ...
        <div className="text-sm whitespace-nowrap overflow-hidden overflow-ellipsis">commented on a Ticket you&apos;re assigned to fix:</div>
        <div className="text-sm">Yes please fix this!!</div>
      </div>
      <div className="ml-4">
