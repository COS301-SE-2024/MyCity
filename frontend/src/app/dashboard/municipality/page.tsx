...
export default function MunicipalityDashboard() {
  ...
  return (
    <div>
      <NavbarMunicipality /> {/* It will be implemented as just rendering the navbar with logic to differentiate */}
      <main>
          ...
          <div className="flex flex-col items-center justify-center rounded-lg h-fit py-1">
            ...
            >
              <Tab key={0} title="Cards">
                <h1 className="text-2xl font-bold mt-2 ml-2">Most up-voted</h1>
                <h1 className="text-l mb-4 ml-2">
                  Based on votes from the community in your area.
                </h1>
                <FaultCardContainer />
                <h1 className="text-2xl font-bold mt-2 ml-2">Nearest to you</h1>
                <h1 className="text-l mb-4 ml-2">
