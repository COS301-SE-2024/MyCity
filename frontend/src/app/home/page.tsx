  ...
  return (
    <>
      <div className="flex flex-col h-screen overflow-hidden">
        ...
        <div className="bottom sm:top w-full z-20">
          <Navbar />
        </div>
        ...
        >
          {/* Content */}
          <div className="container mx-auto p-2 relative z-10 mt-16 md:mt-0 mb-16 md:mb-0">
            {/* Ensure content is above the background */}
            <h1 className="text-4xl text-white font-bold mb-4 sm:text-red-500">
              Be the change in your city <br />
              with <span className="text-blue-200 md:text-blue-500">MyCity</span>.
            </h1>
