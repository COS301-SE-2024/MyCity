...
@tickets_blueprint.route("/add-comment-with-image", authorizer=cognito_authorizer, methods=["POST"], cors=True)
...
@tickets_blueprint.route("/add-comment-without-image", authorizer=cognito_authorizer, methods=["POST"], cors=True)
...
@tickets_blueprint.route("/comments", authorizer=cognito_authorizer, methods=["GET"], cors=True)
...
@tickets_blueprint.route("/geodata/all", authorizer=cognito_authorizer, methods=["GET"], cors=True)
