...
def create_ticket(ticket_data):
    try:
        ...
        required_fields = ['asset', 'description', 'location', 'province', 'state', 'username']
        ...
        raise BadRequestError(f"Failed to create ticket: {e.response['Error']['Message']}")
