...
@profile_routes.route('/profile/update', methods=['PUT'], content_types=['application/json'])
def update_user_profile():
    ...
    return Response(
        body={'message': 'Profile updated successfully', 'updated_attributes': result['updated_attributes']},
        status_code=200
    )
